...
const EmailContainer = ({
  ...
  return (
    <div className="flex flex-col justify-between bg-white rounded-md p-12 pb-16 px-20">
      <div>
      ...
      <div className="flex justify-start items-center  gap-2 mt-[4vh]">
        <Button
          variant={"outline"}
          className="p-[13px] py-[26px]  text-4xl rounded-full"
        >
          {/* <FcGoogle  /> */}
      ...
      <div className="mt-[4vh]">
        ...
        <div className="mt-4">
          ...
          <Input className="mt-1  h-8" type="password" placeholder="Password" />
        </div>
